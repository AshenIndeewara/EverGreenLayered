...
//    reportBO reportBO = new reportBO();
    ReportBO reportBO = (ReportBO) BOFactory.getBoFactory().getBO(BOTypes.REPORTBO);
    ...
    void getReportData(ActionEvent event) {
        ...
        if (report.equals("Customer Report")) {
            ...
            ArrayList<CustomerTDto> customerTDtos = reportBO.getCustomerReport();
            ...
            ArrayList<TicketReportDto> ticketReportDtos = reportBO.getSalesReport();
            salesTable.getItems().clear();
            salesTable.getItems().addAll(ticketReportDtos);
        } else if (report.equals("Animal Report")) {
            animalData.setVisible(true);
            ArrayList<AnimalReportDto> animalReportDtos = reportBO.getAnimalReport();
            ...
            ArrayList<StaffDto> staffDtos = reportBO.getAllStaff();
            ...
            ArrayList<SupplierDto> supplierDtos = reportBO.getAllSupplier();

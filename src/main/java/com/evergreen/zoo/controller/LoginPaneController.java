...
//    private loginPaneBO loginPaneBO = new loginPaneBO();
    LoginPaneBO loginPaneBO = (LoginPaneBO) BOFactory.getBoFactory().getBO(BOTypes.LOGINBO);
    @FXML
...
//        }
    ...
    void checkLogin(ActionEvent event) throws Exception {
        ...
        ResultSet resultSet = loginPaneBO.checkLogin(loginDto);

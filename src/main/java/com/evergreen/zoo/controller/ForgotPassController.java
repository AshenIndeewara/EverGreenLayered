...
import com.evergreen.zoo.dao.impl.ForgotDAOimpl;
...
public class ForgotPassController {
    ...
    ForgotBO forgotBOimpl = (ForgotBO) BOFactory.getBoFactory().getBO(BOTypes.FORGOTBO);
    ...
    void getUserData(ActionEvent event) throws SQLException {
        forgotDto = forgotBOimpl.getUserData(usernameTxt.getText());
        if (forgotDto == null) {
    ...
    public void resetPassFromDB(ActionEvent actionEvent) throws SQLException, IOException {
        if (newPassTxt1.getText().equals(newPassTxt2.getText())) {
            ...
            Boolean isChangeUserPW = forgotBOimpl.isChangeUserPW(forgotDto,newPasswd);

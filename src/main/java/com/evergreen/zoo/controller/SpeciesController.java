...
import com.evergreen.zoo.BO.impl.SpeciesBOimpl;
...
public class SpeciesController implements Initializable {
    ...
    SpeciesBO speciesBOimpl = (SpeciesBO) BOFactory.getBoFactory().getBO(BOTypes.SPECIESBO);
    ...
    private void loadSpecies() {
        ArrayList<SpeciesDto> species = speciesBOimpl.getSpecies();
        itemTable.getItems().clear();
        itemTable.getItems().addAll(species);
    }

    private void loadDiets() {
        ArrayList<String> diets = speciesBOimpl.getDiets();
    ...
    void addSpecies(ActionEvent event) {
        ...
        boolean b = speciesBOimpl.addSpecies(speciesName, speciesDiet, speciesStatus);
        if (b) {
            loadSpecies();
    ...
    void getAnimals(MouseEvent event) {
        ...
        ArrayList<AnimalTDto> animals = speciesBOimpl.getAnimals(selectedItem.getSpeciesID());

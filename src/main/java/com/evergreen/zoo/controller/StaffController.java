...
import com.evergreen.zoo.dao.impl.StaffDAOimpl;
...
//    staffBO staffBO = new staffBO();
    StaffBO staffBO = (StaffBO) BOFactory.getBoFactory().getBO(BOTypes.STAFFBO);
    ...
    void loadRoles() throws SQLException {
        ...
        ArrayList<String> roles = staffBO.getAllRoles();
    ...
    void refreshTable() throws SQLException {
        ...
        ArrayList<StaffDto> allStaff = staffBO.getAllStaff();
    ...
    void searchStaff(KeyEvent event) throws SQLException {
        ArrayList<StaffDto> staff = staffBO.searchStaff(searchBox.getText());
        ObservableList<StaffDto> staffTMS = FXCollections.observableArrayList();

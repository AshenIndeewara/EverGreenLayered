...
//    registerBO registerBO = new registerBO();
    RegisterPaneBO registerBO = (RegisterPaneBO) BOFactory.getBoFactory().getBO(BOTypes.FORGOTBO);
    ...
    void checkRegistor(ActionEvent event) throws Exception {
        ...
        int roleId = registerBO.getRoleIdByDescription(position);
        ...
        if(registerBO.registerUser(registerDto)){
    ...
    void loadRoles() throws SQLException {
        role.getItems().clear();
        ArrayList<String> roles = registerBO.getAllRoles();

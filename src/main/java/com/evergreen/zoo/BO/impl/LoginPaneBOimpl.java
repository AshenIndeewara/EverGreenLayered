...
import com.evergreen.zoo.dao.LoginDAOimpl;
import com.evergreen.zoo.dto.LoginDto;
import com.evergreen.zoo.util.QrController;
...
public class LoginPaneBOimpl implements Initializable {
...
//        }
    ...
    public void loadWindow(String path, boolean b, int role) throws IOException {
        ...
        AdminDashboardBOimpl adminDashboardController = loader.getController();
    ...
    void checkLogin(ActionEvent event) throws Exception {
        ...
        ResultSet resultSet = loginDAOimpl.checkLogin(loginDto);

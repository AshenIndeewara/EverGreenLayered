...
import com.evergreen.zoo.dao.AnimalDAOimpl;
...
public class AnimalPaneBOimpl implements Initializable {
    @FXML
    ...
    private final AnimalDAOimpl animalDAOimpl = new AnimalDAOimpl();
    ...
    private void loadEmployeeID() {
        emID.getItems().clear();
        ArrayList<String> employeeIDs = animalDAOimpl.getEmployeeID();
    ...
    private void loadAnimalTable() {
        ArrayList<AnimalTDto> animalTDtos = animalDAOimpl.getAnimals();
...
//        }
    ...
    private void getSpecies() {
        ArrayList<String> species = animalDAOimpl.getSpecies();
    ...
    void addAnimal(ActionEvent event) throws SQLException {
        ...
        if (animalDAOimpl.isAddAnimal(animalDto)){
            loadAnimalTable();
    ...
    void getDiet(ActionEvent event) {
        ...
        String diet1 = animalDAOimpl.getDiet(diet);
    ...
    void deleteAnimal(ActionEvent event) throws SQLException {
        ...
        Boolean isDelete = animalDAOimpl.isDeleteAnimal(selectedItem.getAnimalID());
        if (isDelete){
            loadAnimalTable();
    ...
    void searchAnimal(KeyEvent event) {
        ...
        ArrayList<AnimalTDto> animalTDtos = animalDAOimpl.searchAnimal(search);
        animalTable.getItems().clear();
        animalTable.getItems().addAll(animalTDtos);
    }
    ...
    void updateAnimal(ActionEvent event) {
        ...
        animalDto.setSpecies(animalDAOimpl.getSpeciesID(animalSpecies.getSelectionModel().getSelectedItem()));
        ...
        Boolean isUpdate = animalDAOimpl.isUpdateAnimal(selectedItem.getAnimalID(), animalDto);
        if (isUpdate) {
            loadAnimalTable();

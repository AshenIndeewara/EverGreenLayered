...
import com.evergreen.zoo.dao.ForgotDAOimpl;
...
public class ForgotPassBOimpl {
    ...
    void getUserData(ActionEvent event) throws SQLException {
        forgotDto = ForgotDAOimpl.getUserData(usernameTxt.getText());
        if (forgotDto == null) {
    ...
    public void resetPassFromDB(ActionEvent actionEvent) throws SQLException, IOException {
        if (newPassTxt1.getText().equals(newPassTxt2.getText())) {
            ...
            Boolean isChangeUserPW = ForgotDAOimpl.isChangeUserPW(forgotDto,newPasswd);

...
public class RegisterPaneBOimpl implements Initializable {
    ...
    void checkRegistor(ActionEvent event) throws Exception {
        ...
        int roleId = registerDAOimpl.getRoleIdByDescription(position);
        ...
        if(registerDAOimpl.registerUser(registerDto)){

...
import com.evergreen.zoo.dao.ReportDAOimpl;
...
public class ReportBOimpl implements Initializable {
    ...
    void getReportData(ActionEvent event) {
        ...
        if (report.equals("Customer Report")) {
            ...
            ArrayList<CustomerTDto> customerTDtos = reportDAOimpl.getCustomerReport();
            ...
            ArrayList<TicketReportDto> ticketReportDtos = reportDAOimpl.getSalesReport();
            salesTable.getItems().clear();
            salesTable.getItems().addAll(ticketReportDtos);
        } else if (report.equals("Animal Report")) {
            animalData.setVisible(true);
            ArrayList<AnimalReportDto> animalReportDtos = reportDAOimpl.getAnimalReport();
            ...
            ArrayList<StaffDto> staffDtos = reportDAOimpl.getAllStaff();
            ...
            ArrayList<SupplierDto> supplierDtos = reportDAOimpl.getAllSupplier();

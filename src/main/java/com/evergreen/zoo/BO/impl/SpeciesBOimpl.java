...
import com.evergreen.zoo.dao.SpeciesDAOimpl;
...
public class SpeciesBOimpl implements Initializable {
    ...
    SpeciesDAOimpl speciesDAOimpl = new SpeciesDAOimpl();
    ...
    private void loadSpecies() {
        ArrayList<SpeciesDto> species = speciesDAOimpl.getSpecies();
        itemTable.getItems().clear();
        itemTable.getItems().addAll(species);
    }

    private void loadDiets() {
        ArrayList<String> diets = speciesDAOimpl.getDiets();
    ...
    void addSpecies(ActionEvent event) {
        ...
        boolean b = speciesDAOimpl.addSpecies(speciesName, speciesDiet, speciesStatus);
        if (b) {
            loadSpecies();
    ...
    void getAnimals(MouseEvent event) {
        ...
        ArrayList<AnimalTDto> animals = speciesDAOimpl.getAnimals(selectedItem.getSpeciesID());
